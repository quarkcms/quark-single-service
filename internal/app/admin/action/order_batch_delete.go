...
type OrderBatchDeleteAction struct {
	actions.Action
}

// 批量删除订单
func OrderBatchDelete() *OrderBatchDeleteAction {
	return &OrderBatchDeleteAction{}
}

// 初始化
func (p *OrderBatchDeleteAction) Init(ctx *quark.Context) interface{} {
...
func (p *OrderBatchDeleteAction) GetApiParams() []string {
	return []string{
		"id",
	}
}
