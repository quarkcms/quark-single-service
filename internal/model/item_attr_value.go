...
type ItemAttrValue struct {
	...
	SK        string  `json:"suk" gorm:"not null;comment:'商品属性索引值 (attr_value|attr_value[|....]'"` // 商品属性索引值
	...
	Unique    string  `json:"unique" gorm:"not null;default:'';comment:'唯一值';index:unique"`        // 唯一值
