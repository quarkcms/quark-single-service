...
type OrderDetail struct {
	...
	OrderId     uint              `json:"order_id" gorm:"not null;comment:订单id;uniqueIndex:order_id(32)"`       // 订单id
	...
	Unique      string            `json:"unique" gorm:"size:32;not null;comment:唯一id;uniqueIndex:order_id(32)"` // 唯一id
